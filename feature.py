...
data['minkowski_distance'] = [minkowski(x, y) for (x, y) in zip(np.nan_to_num(question1_vectors), np.nan_to_num(question2_vectors))]
...
data.to_csv('data/f2.csv', index=False)
